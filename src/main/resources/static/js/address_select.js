    ...
    for (i = 0; i < $(target).length; i++) {
        (function (z) {
            ...
            $(a1).on("change", function () {
                ...
                updateClubLocation(); // 지역 선택 변경 시 주소 업데이트
            });
            ...
            $(a2).on("change", function () {
                ...
                updateClubLocation(); // 도 선택 변경 시 주소 업데이트
            });

            $(a3).on("change", function () {
                updateClubLocation(); // 시군구 선택 변경 시 주소 업데이트
            });
        })(i);
...
function updateClubLocation() {
    let addressDo = $('#addressDo1').val();
    let addressSiGunGu = $('#addressSiGunGu1').val();
    let clubLocation = addressDo + " " + addressSiGunGu;
    $('#clubLocation').val(clubLocation);
}